...
public class AwsVendedTokenProviderTest {
    ...
    public void testTableBasedTemporaryCredentialsRenew() throws Exception{
        ...
        conf.set(Constants.UNITY_CATALOG_CREDENTIALS_TYPE, Constants.UNITY_CATALOG_TABLE_CREDENTIALS_TYPE);
    ...
    public void testCredentialsRenew(Configuration conf, TemporaryCredentialsApi tempCredApi) throws Exception {
