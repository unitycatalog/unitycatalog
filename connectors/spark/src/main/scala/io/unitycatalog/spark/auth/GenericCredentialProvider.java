...
public abstract class GenericCredentialProvider {
  ...
  public GenericCredentialProvider(Configuration conf) {
    ...
    this.globalCredCacheEnabled = conf.getBoolean(
        UCHadoopConf.UC_GLOBAL_CREDENTIAL_CACHE_ENABLED_KEY,
        UCHadoopConf.UC_GLOBAL_CREDENTIAL_CACHE_ENABLED_VALUE);
