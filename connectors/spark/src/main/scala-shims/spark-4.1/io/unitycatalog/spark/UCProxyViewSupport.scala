...
/**
 * Empty Spark-4.1 shim for [[UCProxyViewSupport]] (the real implementation lives
 * in `scala-shims/spark-4.2/`). Provides the `wrapAsView` hook that throws on Spark 4.1
