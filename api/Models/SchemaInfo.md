...
| **storage\_root** | **String** | Storage root URL for managed securables within schema. This can be set when creating a schema. | [optional] [default to null] |
| **storage\_location** | **String** | Storage Location URL (full path) for managed securables within schema. This is an automatically generated unique path under storage_root. If it&#39;s absent, managed securables under this schema will try to use storage_location of the parent catalog instead. | [optional] [default to null] |
