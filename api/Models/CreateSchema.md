...
| **storage\_root** | **String** | Storage root URL for managed securables within schema. If not set, managed securables under this schema will try to use the storage_location of the parent catalog instead. | [optional] [default to null] |
