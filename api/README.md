...
| *CoordinatedCommitsApi* | [**commit**](Apis/CoordinatedCommitsApi.md#commit) | **POST** /delta/preview/commits | Commit changes to a specified table WARNING: This API is experimental and will change in future versions.  |
*CoordinatedCommitsApi* | [**getCommits**](Apis/CoordinatedCommitsApi.md#getcommits) | **GET** /delta/preview/commits | List unbackfilled Delta table commits. WARNING: This API is experimental and will change in future versions.  |
