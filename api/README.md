...
| *ViewsApi* | [**createView**](Apis/ViewsApi.md#createview) | **POST** /views | Create a view. Only regular view creation is supported. WARNING: This API is experimental and will change in future versions.  |
*ViewsApi* | [**deleteView**](Apis/ViewsApi.md#deleteview) | **DELETE** /views/{full_name} | Delete a view |
*ViewsApi* | [**getView**](Apis/ViewsApi.md#getview) | **GET** /views/{full_name} | Get a view |
