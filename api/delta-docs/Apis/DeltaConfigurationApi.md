# DeltaConfigurationApi

All URIs are relative to *https://localhost:8080/api/2.1/unity-catalog*

| Method | HTTP request | Description |
|------------- | ------------- | -------------|
| [**getConfig**](DeltaConfigurationApi.md#getConfig) | **GET** /delta/v1/config | Get catalog configuration |


<a name="getConfig"></a>
# **getConfig**
> DeltaCatalogConfig getConfig(catalog, protocol-versions)
