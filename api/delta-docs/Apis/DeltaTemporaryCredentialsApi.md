...
|------------- | ------------- | -------------|
| [**getStagingTableCredentials**](DeltaTemporaryCredentialsApi.md#getStagingTableCredentials) | **GET** /delta/v1/staging-tables/{table_id}/credentials | Get staging table credentials by UUID |
| [**getTableCredentials**](DeltaTemporaryCredentialsApi.md#getTableCredentials) | **GET** /delta/v1/catalogs/{catalog}/schemas/{schema}/tables/{table}/credentials | Get table credentials |
| [**getTemporaryPathCredentials**](DeltaTemporaryCredentialsApi.md#getTemporaryPathCredentials) | **GET** /delta/v1/temporary-path-credentials | Get temporary path credentials |


<a name="getStagingTableCredentials"></a>
# **getStagingTableCredentials**
> DeltaCredentialsResponse getStagingTableCredentials(table\_id)
...
# **getTableCredentials**
> DeltaCredentialsResponse getTableCredentials(operation, catalog, schema, table)
...
|Name | Type | Description  | Notes |
|------------- | ------------- | ------------- | -------------|
| **operation** | [**DeltaCredentialOperation**](../Models/.md)| The operation the credential is scoped to. | [default to null] [enum: READ, READ_WRITE] |
...
> DeltaCredentialsResponse getTemporaryPathCredentials(location, operation)
...
| **operation** | [**DeltaCredentialOperation**](../Models/.md)| Operation type for the path credential. | [default to null] [enum: READ, READ_WRITE] |
