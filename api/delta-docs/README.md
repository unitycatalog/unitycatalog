...
*DeltaIdentitySequencesApi* | [**dropIdentitySequences**](Apis/DeltaIdentitySequencesApi.md#dropidentitysequences) | **POST** /delta/v1/catalogs/{catalog}/schemas/{schema}/tables/{table}/identities/drop | Drop one or more identity sequences. WARNING: This API is experimental and may change in future versions.  |
