...
|------------- | ------------- | ------------- | -------------|
| **securable\_type** | [**SecurableType**](../Models/.md)| Type of securable. | [default to null] [enum: metastore, catalog, schema, table, view, function, volume, registered_model, external_location, credential] |
