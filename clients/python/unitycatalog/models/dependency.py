...
class Dependency(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["table", "function"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "table": TableDependency.from_dict(obj["table"]) if obj.get("table") is not None else None,
            "function": FunctionDependency.from_dict(obj["function"]) if obj.get("function") is not None else None
        })
        return _obj
