...
class TableInfo(BaseModel):
    ...
    columns: Optional[List[ColumnInfo]] = Field(default=None, description="The array of __ColumnInfo__ definitions of the table's columns.")
    ...
    __properties: ClassVar[List[str]] = ["name", "catalog_name", "schema_name", "table_type", "data_source_format", "columns", "storage_location", "comment", "properties", "created_at", "updated_at", "table_id"]
