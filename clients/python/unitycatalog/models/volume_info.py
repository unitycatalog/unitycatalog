...
class VolumeInfo(BaseModel):
    ...
    volume_id: Optional[StrictStr] = Field(default=None, description="Unique identifier for the volume")
    ...
    __properties: ClassVar[List[str]] = ["catalog_name", "schema_name", "name", "comment", "created_at", "updated_at", "volume_id", "volume_type", "storage_location", "full_name"]
