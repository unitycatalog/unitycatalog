...
class TestCreateFunctionRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CreateFunctionRequest:
        """Test CreateFunctionRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateFunctionRequest`
        """
        model = CreateFunctionRequest()
        if include_optional:
            return CreateFunctionRequest(
                function_info = unitycatalog.models.create_function.CreateFunction(
                    name = '', 
                    catalog_name = '', 
                    schema_name = '', 
    ...
    def testCreateFunctionRequest(self):
        """Test CreateFunctionRequest"""
