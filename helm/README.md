...
![Version: 0.0.1-pre.1](https://img.shields.io/badge/Version-0.0.1--pre.1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v0.3.0](https://img.shields.io/badge/AppVersion-v0.3.0-informational?style=flat-square)
...
Supports Unity Catalog OSS 0.3.0 and up.

> **Note**
>
> Unity Catalog OSS UI is in early stage of development and may not be suitable for production usage.
>
