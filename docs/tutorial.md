...
For detailed information on the commands, please refer to the [CLI documentation](./cli.md)
...
Behind the scenes, the invocation of the function is achieved by calling the python script at `etc/data/function/python_engine.py`
