...
- For the **App information** dialog, please provide the _App name_, _user-supported_ _email_, and _Developer contact information_ at a minimum. Click **Save and Continue**.

- For the purpose of this demo, skip _Scopes,_ _Test users_, and go directly to _Summary_ return **Back to Dashboard**.
