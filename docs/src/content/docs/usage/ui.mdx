...
<Tabs>
<TabItem label="1. List and create catalogs">
...
<Tabs>
<TabItem label="2. Create catalog dialog">
...
<Tabs>
<TabItem label="3. Delete a catalog">

Click the _horizontal three dots_ next to **Create Schema** button to delete your catalog.
...
<Tabs>
<TabItem label="1. List and create schemas">
...
<Tabs>
<TabItem label="2. Create schemas dialog">
...
<Tabs>
<TabItem label="3. Delete a schema">

Click the _horizontal three dots_ to the right to delete your schema.
...
<Tabs>
<TabItem label="1. View tables in schema (1)">
...
<Tabs>
<TabItem label="2. View tables in schema (2)">
...
<Tabs>
<TabItem label="3. View table metadata">

Click on any table (e.g., `unity.default.marksheet`) to view its metadata. You also have the option to delete the table via the _three horizontal dots_ on the right.
...
<Tabs>
<TabItem label="1. Traverse to volumes">

Using the left-hand nav bar, click on _catalog > schema_ (e.g., `unity` > `default`) to view the available volumes.
...
<Tabs>
<TabItem label="2. View volume metadata">

Click on the volume (e.g., `unity.default.txt_files`) to view its metadata. You have the option to delete it by click on the _three horizontal dots_ to the right.
...
<Tabs>
<TabItem label="3. Edit volume description">
...
<Tabs>
<TabItem label="1. Traverse to functions">

Using the left-hand nav bar, click on _catalog > schema_ (e.g., `unity` > `default`) to view the available functions.
...
<Tabs>
<TabItem label="2. View functions metadata">

Click on the volume (e.g., `unity.default.lowercase`) to view its metadata. You have the option to delete it by click on the _three horizontal dots_ to the right.
...
<Tabs>
<TabItem label="1. List and create models">

After clicking on any _schema > models_, the main dialog contains the list of available models. Click the **horizontal three dots** button to the right to create a new model.
...
<Tabs>
<TabItem label="3. Create model dialog">
...
<Tabs>
<TabItem label="4. Edit model description">
...
<Tabs>
<TabItem label="5. Delete a model">

Click the _horizontal three dots_ to the right to delete your model.
...
<Tabs>
<TabItem label="1. Traverse to models">

Using the left-hand nav bar, click on _catalog > schema_ (e.g., `unity` > `default`) to view the available models.
...
<Tabs>
<TabItem label="2. View model versions">
...
<Tabs>
<TabItem label="3. View model version metadata">
...
<Tabs>
<TabItem label="4. Edit model version description">
...
<Tabs>
<TabItem label="5. Delete a model version">

Click the _horizontal three dots_ to the right to delete your model version.
