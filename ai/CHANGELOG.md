...
- [unitycatalog-autogen](https://pypi.org/project/unitycatalog-autogen) has been overhauled to support the new `0.4.x` overhaul of [AutoGen](https://www.microsoft.com/en-us/research/project/autogen/). Support for earlier versions of the `autogen` or `ag2` packages has been dropped. To read more about what this reimagining of the library is all about and to learn how to migrate to the new APIs, see [this post](https://www.microsoft.com/en-us/research/blog/autogen-v0-4-reimagining-the-foundation-of-agentic-ai-for-scale-extensibility-and-robustness/).
