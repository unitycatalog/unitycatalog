...
public class IcebergRestClient {
  ...
  public boolean namespaceExists(String catalog, String namespace) throws ApiException {
    HttpResponse<String> response = head(namespacePath(catalog, namespace));
    int code = response.statusCode();
    // Mirrors tableExists: any 2xx is "exists", 404 is "does not exist", anything else is an error.
  ...
  public void dropNamespace(String catalog, String namespace) throws ApiException {
    checkSuccess(delete(namespacePath(catalog, namespace)));
  }

  public UpdateNamespacePropertiesResponse updateNamespaceProperties(
      String catalog, String namespace, UpdateNamespacePropertiesRequest request)
      throws ApiException {
    return parse(
        post(namespacePath(catalog, namespace) + "/properties", toJson(request)),
        UpdateNamespacePropertiesResponse.class);
  }

  public LoadCredentialsResponse loadCredentials(String catalog, String namespace, String table)
      throws ApiException {
    return parse(
        get(tablePath(catalog, namespace, table) + "/credentials"), LoadCredentialsResponse.class);
  }
