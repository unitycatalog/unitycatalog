...
public interface VolumeOperations {
    ...
    List<VolumeInfo> listVolumes(String catalogName, String schemaName) throws ApiException;
    VolumeInfo getVolume(String volumeFullName) throws ApiException;
    VolumeInfo updateVolume(String fullName, UpdateVolumeRequestContent updateVolumeRequest) throws ApiException;
