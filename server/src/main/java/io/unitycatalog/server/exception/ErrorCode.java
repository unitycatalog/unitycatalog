...
public enum ErrorCode {
  ...
  UNSUPPORTED_TABLE_FORMAT(3, 400, ErrorType.UNSUPPORTED_TABLE_FORMAT_EXCEPTION),
  ...
  UPDATE_REQUIREMENT_CONFLICT(9, 409, ErrorType.UPDATE_REQUIREMENT_CONFLICT_EXCEPTION),
