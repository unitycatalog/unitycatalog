...
public class ViewService extends AuthorizedService {
  ...
  @AuthorizeExpression("""
      ...
      """)
  @AuthorizeResourceKey(METASTORE)
  public HttpResponse getView(@Param("full_name") @AuthorizeResourceKey(TABLE) String fullName) {
  ...
  @AuthorizeExpression("""
      ...
      """)
  @AuthorizeResourceKey(METASTORE)
  public HttpResponse deleteView(@Param("full_name") @AuthorizeResourceKey(TABLE) String fullName) {
    ViewInfo viewInfo = viewRepository.getView(fullName);
