 ...
 */
public class TemporaryExceptionHandlingDecorator implements DecoratingHttpServiceFunction {

  private final ExceptionHandlerFunction exceptionHandlerFunction;

  public TemporaryExceptionHandlingDecorator(ExceptionHandlerFunction exceptionHandlerFunction) {
