...
public class BaseSparkTest {
  ...
  private static final String renewalEnabled = System.getenv().getOrDefault(
      "CREDENTIAL_RENEWAL_ENABLED", "false");
    ...
    for (String catalog : catalogs) {
      ...
      builder =
          builder
              ...
              .config(catalogConf + ".renewCredential.enabled", renewalEnabled);
    }
